...
class SingleShotLocationProvider {
    ...
    public static void requestSingleUpdate(final Context context, final LocationCallback callback) {
        ...
        if (isNetworkEnabled) {
            ...
            {
                if(Persistencia.checkPermission(context,  Manifest.permission.ACCESS_FINE_LOCATION, 1) &&
                        Persistencia.checkPermission(context,  Manifest.permission.ACCESS_COARSE_LOCATION, 1)){
